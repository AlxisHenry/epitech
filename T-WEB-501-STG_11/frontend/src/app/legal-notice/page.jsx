...
export default function Home() {
  ...
  return (
    <Layout>
      <Title content="Legal notice" />
      <div className="legals">
        <h1 class="legals-h1">Disclaimer</h1>
        <p>
          Today date: <b>{todayDate.toLocaleDateString("en-GB")}</b>
        </p>
        <h1 class="legals-h1">Interpretation and Definitions</h1>
        <br />
        <h2 class="legals-h2">Interpretation</h2>
        <p>
        ...
        <h2 class="legals-h2">Definitions</h2>
        <p>For the purposes of this Disclaimer:</p>
        <ul>
          <li>
            <strong>Company</strong> (referred to as either &quot;the
            Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in
            this Disclaimer) refers to Job Quest Inc.
          </li>
          <li>
          ...
          <li>
            <strong>Website</strong> refers to Job Quest Inc, accessible
            from&nbsp;
            <a
        ...
        <h1 class="legals-h1">External Links Disclaimer</h1>
        <p>
        ...
        <h1 class="legals-h1">Errors and Omissions Disclaimer</h1>
        <p>
        ...
        <h1 class="legals-h1">Fair Use Disclaimer</h1>
        <p>
        ...
        <h1 class="legals-h1">Views Expressed Disclaimer</h1>
        <p>
        ...
        <h1 class="legals-h1">No Responsibility Disclaimer</h1>
        <p>
        ...
        <h1 class="legals-h1">&quot;Use at Your Own Risk&quot; Disclaimer</h1>
        <p>
        ...
        <p>
          Téléphone : +33 (0) 899 701 761 (1.349 € TTC l’appel, et 0.337 €
          TTC/mn)
        </p>
        <p>Fax : + 33 (0) 3 20 20 09 58</p>
        <p>Michel Paulin, Directeur Général</p>
        <p>
          OVH SAS, société au capital de 10 174 560 €, RCS Lille Métropole 424
          761 419 00045, Code APE 6202A, N° TVA : FR 22 424 761 419, Siège
          social : 2 rue Kellermann - 59100 Roubaix - France
        </p>
        <h1 class="legals-h1">Contact Us</h1>
        <p>
          If you have any questions about this Disclaimer, You can contact Us:
        </p>
        <ul>
          <li>
            <p>By email: jobquest.epitech@gmail.com</p>
          </li>
        </ul>
      </div>
    </Layout>
